...
class CandlestickChart extends React.Component {
	...
	setViewPeriodHandler = (type)=>{
		console.log(type);
		this.setState({activeViewPeriod:type},()=>{
			this.props.updateChartData(type)
		});
	}
	render() {
		//Show chart for 1 minute, 15 minute, 4 hour and 1 day intervals
...
var gridHeight = 600 - margin.top - margin.bottom;
...
var xGrid = showGrid ? { 
    ...
    tickStrokeWidth: 1
		...
		return (
			<div>
				<PeriodInterval  
				 onSetViewPeriod={this.setViewPeriodHandler} 
				 activePeriod={this.state.activeViewPeriod} 
				 />
